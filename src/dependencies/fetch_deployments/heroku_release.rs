...
use crate::dependencies::read_project_config::interface::ProjectConfig;
...
async fn get_slug(project_config: ProjectConfig, app_name: &str, slug_id: &str) -> Result<HerokuSlugItem, Error> {
