...
use crate::{project_creating::{validate_github_personal_token::{self, schema::ValidateGitHubPersonalTokenError}, validate_github_owner_repo::{self, schema::ValidateGitHubOwnerRepoError}, validate_developer_count::{self, schema::ValidateDeveloperCountError}, validate_working_days_per_week::{self, schema::ValidateWorkingDaysPerWeekError}}, common_types::{ConfigData, ProjectConfig}};

use super::schema::GitHubDeploymentProjectCreated;

pub type GitHubDeploymentProjectCreatedDto = ConfigData;
...
impl GitHubDeploymentProjectCreatedDto {
    pub fn to_git_hub_deployment_project_created(dto: &ConfigData) -> Result<GitHubDeploymentProjectCreated, ToGitHubDeploymentProjectCreatedError> {
    ...
    pub fn from_git_hub_deployment_project_created(domain_obj: GitHubDeploymentProjectCreated) -> ConfigData {
