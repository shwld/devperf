...
pub fn perform(count: UnvalidatedWorkingDaysPerWeek) -> Result<ValidateWorkingDaysPerWeekEvent, ValidateWorkingDaysPerWeekError> {
    ...
    pub fn new(count: String) -> Result<Self, ValidateWorkingDaysPerWeekError> {
      ...
      if count.is_ok() {
          ...
          if count > 0.0 && count < 7.0 {
            ...
            Err(ValidateWorkingDaysPerWeekError("Developer count is zero".to_string()))
          }
      } else {
